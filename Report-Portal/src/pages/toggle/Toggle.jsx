...
<div class="offcanvas offcanvas-start canva-color" tabindex="-1" id="offcanvasExample" aria-labelledby="offcanvasExampleLabel">
  <div class="offcanvas-header">
    <h5 class="offcanvas-title" id="offcanvasExampleLabel">Hi UserName</h5>
    <button type="button" class="btn-close" data-bs-dismiss="offcanvas" aria-label="Close"></button>
  </div>
  <div class="offcanvas-body">
    <div>
      {user.isAdmin ? 'You Are An Admin' : !user.isAdmin ? 'You Are Now A Member' : ''}
    ...
    {/* HOME SIDE BAR------------------------------------- */}
        ...
        <ul className="sidebar2">
          ...
          <Link to="/" className="listLink">
            ...
            <span className="sidelinktext2"><h5>Home</h5></span>
            </Link>
          </li>
          <li className="sidebarList2">
            {/* {user?.isFan === true ? "" : */}
            ...
            <span className="sidelinktext2 others" ><h5>Create Report</h5></span>
            </Link>
            {/* }      */}
          </li>
          <li className="sidebarList2">
          <Link to="/score-card" className="listLink">
            ...
            <span className="sidelinktext2 "><h5>Scorecard</h5></span>
            </Link>
          </li>
          <li className="sidebarList2">
          <Link to="/appraisals" className="listLink">
            ...
            <span className="sidelinktext2"><h5>Appraisals</h5></span>
            </Link>
          </li>
          <li className="sidebarList2">
          <Link to="/announcements" className="listLink">
            ...
            <span className="sidelinktext2"><h5>Announcements</h5></span>
            </Link>
          </li>
          <li className="sidebarList2">
          <Link to="/testimony" className="listLink">
            ...
            <span className="sidelinktext2"><h5>Testimony</h5></span>
            </Link>
          </li>
