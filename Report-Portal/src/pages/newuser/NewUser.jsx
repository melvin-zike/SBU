        ...
        <div class="row justify-content-center">
          <div class="col-12 col-md-8 col-lg-8 col-xl-6">
            ...
            >
              ...
              <option value="5">RBIM & LWPM</option>
              <option value="6">ROR SBU RLM Team B Unit 4</option>
              <option value="7">ROR SBU RLM Team B Unit 5</option>
              <option value="8">Lagos UK/Office</option>
              <option value="9">Performance Management</option>
            ...
            <div class="row justify-content-start mt-4">
              <div class="col">
                <button class="btn btn-primary mt-4" onClick={handleClick}>
                  Register
                </button>
              </div>
            </div>
