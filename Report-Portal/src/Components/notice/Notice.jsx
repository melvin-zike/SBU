...
const Notice = () => {
  return (
    <div>
           <div class="card">
                <div class="card-body">
                  <h4 class="card-title mb-0">Notification/Updates (<i>coming soon...)</i></h4>
                </div>
                <ul class="list-style-none">
                  <li class="d-flex no-block card-body">
                    ...
                    <div>
                      ...
                      <span class="text-muted"
                        >Start your day with the word of God</span
                      >
                    </div>
                    <div class="ms-auto">
                  ...
                  <li class="d-flex no-block card-body border-top">
                    ...
                    <div>
                      <a href="#" class="mb-0 font-medium p-0">
                        I am alway here if you have any question</a
                      >
                      <span class="text-muted"
